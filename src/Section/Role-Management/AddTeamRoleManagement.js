...
const AddTeamRoleManagement = () => {
  ...
  const handleSubmit = (roles) => {
    ...
    DataService.updateTeamRole(data).then(
      () => {
  ...
  const handleSelectAll = () => {
    ...
    const newRoles = newCheckedState ? ["admin", "TL"] : [];
...
export default AddTeamRoleManagement;
