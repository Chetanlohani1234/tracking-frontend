              ...
              <form onSubmit={handleSubmit}>
                <div className="add-project-form">
                  <div className="left-side-add-fom">
                    ...
                    <div className="select-project-performace">
                      <label>
                      ...
                      <div className="label-filed">
                        <select
                          className="select-label-team-performance"
                  ...
                  <div className="right-side-add-form">
                    <div className="label-field">
                      <label>
                        Prject Name <span className="red-required">* </span>
                      </label>
                    </div>
                    <div className="label-field">
                      <input
                    ...
                    <div className="label-field">
                      <label>
                        Start date <span className="red-required">* </span>
                      </label>
                    </div>
                    <div className="label-field">
                      <input
                    ...
                    <div className="label-field">
                      <label>
                        End date <span className="red-required">* </span>
                      </label>
                    </div>
                    <div className="label-field">
                      <input
              ...
              <div className="add-project-form">
                <div className="left-side-add-fom">
                  ...
                  <div className="label-field-status">
                    <div className="label-field">
                      <label>
                        Change Status <span className="red-required">* </span>
                      </label>
                    </div>
                    <div className="label-field">
                      <select
